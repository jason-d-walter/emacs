...
(define-key global-map "\M-p" 'print-var-at-cursor)
(define-key global-map [(f11)] 'line-file-lookup-at-cursor-forward)
(define-key global-map [(f12)] 'line-file-lookup-at-cursor-bkward)
